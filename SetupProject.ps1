# ===============================================================
# PowerShell Script: SetupProject.ps1
# ===============================================================
...
#      └── ab-test.css
#
# It then outputs the directory structure and prints each file’s content.
# ===============================================================

# Create the project root and public directories
New-Item -Path ".\ABTestingProject" -ItemType Directory -Force
New-Item -Path ".\ABTestingProject\public" -ItemType Directory -Force
...
'@
Set-Content -Path ".\ABTestingProject\package.json" -Value $packageJson
...
'@
Set-Content -Path ".\ABTestingProject\vercel.json" -Value $vercelJson

# -------------------------
# Create ab-testing.js file
# (This file combines all our centralized JavaScript code:
#  tracking-core, assignment-manager, ab-testing-system, and postgres-reporter)
# -------------------------
$abTestingJs = @'
/* ============================================
   Tracking Core
...
'@
Set-Content -Path ".\ABTestingProject\public\ab-testing.js" -Value $abTestingJs

# -------------------------
# Create ab-test.css file (example CSS)
# -------------------------
$abTestCss = @'
/* Example CSS for AB Testing */
.ab-active { background-color: #f0f0f0; }
'@
Set-Content -Path ".\ABTestingProject\public\ab-test.css" -Value $abTestCss

# -------------------------
# List the project structure and the content of each file
# -------------------------
Write-Output "Project structure created under 'ABTestingProject':"
Get-ChildItem -Recurse -Path ".\ABTestingProject"

Write-Output "`nContents of package.json:"
Get-Content -Path ".\ABTestingProject\package.json"

Write-Output "`nContents of vercel.json:"
Get-Content -Path ".\ABTestingProject\vercel.json"

Write-Output "`nContents of public\ab-testing.js:"
Get-Content -Path ".\ABTestingProject\public\ab-testing.js"

Write-Output "`nContents of public\ab-test.css:"
Get-Content -Path ".\ABTestingProject\public\ab-test.css"
